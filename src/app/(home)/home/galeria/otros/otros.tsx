         ...
         <div className="p-6 bg-[#d6dfe7] min-h-[100vh] flex flex-col">
            <div className="max-w-2xl mb-10">
               <h1 className="text-main font-(family-name:--font-montserrat) font-semibold text-2xl pb-6">
                  Subida de otros comprobantes
               </h1>
               <p className="text-main font-(family-name:--font-montserrat) font-medium text-lg">
                  En esta sección podés subir imágenes o archivos PDF que no
                  correspondan a operaciones de las otras categorías. Incluí una
                  breve descripción para identificar el archivo con mayor
                  facilidad.
               </p>
            </div>
