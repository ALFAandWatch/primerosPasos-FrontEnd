      ...
      <>
         <div className="lg:ml-2 bg-fondo p-6 min-h-[100vh] lg:pr-56 pb-30">
            <h1 className="text-main font-(family-name:--font-montserrat) font-semibold text-2xl pb-6">
               Registro de Ventas Contado
            </h1>
            <h2 className="text-main font-(family-name:--font-montserrat) font-medium text-lg">
               Complete los datos de cada venta contado en la tabla.
            </h2>
                  ...
                  <Form className="font-(family-name:--font-open-sans)">
                     <table className="table-auto w-full border-collapse">
                        <caption className="text-left text-main font-(family-name:--font-montserrat) font-semibold text-base pb-2 lg:pb-4">
                           Detalle de ventas contado ingresadas:
                        </caption>
                           ...
                           {({ push, remove }) => (
                              <tbody>
                                 {values.movimientos.map((mov, index) => (
                                    <tr
                                       key={index}
                                       className="flex flex-col lg:table-row text-sm text-[#2E2E2E] bg-[#FFF8DC] even:bg-[#FFF0B3] hover:bg-[#FFE699] mb-10 lg:mb-0"
                                    >
                                       <td className="border-2 border-yellow-600/30 flex lg:table-cell relative">
                                          ...
                                          <Field
                                             ...
                                             type="text"
                                             placeholder="Código"
                                             className={`text-black p-4 text-left font-medium w-46 focus:outline-none focus:ring-2 focus:ring-blue-400 h-full leading-none ${
                                                (
                                                   errors.movimientos?.[
                                                      index
                                       ...
                                       <td className="border-2 border-yellow-600/30 flex lg:table-cell">
                                          ...
                                          <Field
                                             ...
                                             type="number"
                                             placeholder="Precio"
                                             className={`text-black p-4 text-right font-medium w-46 focus:outline-none focus:ring-2 focus:ring-blue-400 h-full ${
                                                (
                                                   errors.movimientos?.[
                                                      index
                                                   ] as FormikErrors<movimientoType>
                                          ...
                                          >
                                             {({ field, form }: any) => (
                                                <DatePicker
                                                   ...
                                                   maxDate={today}
                                                   className={`text-black p-4 w-46 focus:outline-none focus:ring-2 focus:ring-blue-400 text-center h-full ${
                                                      (
                                                         errors.movimientos?.[
                                                            index
                                                         ] as FormikErrors<movimientoType>
