      ...
      <>
         <div className="p-6 bg-[#d6dfe7] min-h-[100vh] flex flex-col">
            ...
            <p className="text-main font-(family-name:--font-montserrat) font-medium text-lg">
               ...
               tu contador relacionados con los balances contables y financieros
               de tu empresa. Revisa periódicamente este apartado para mantener
               un control actualizado de tu situación económica y asegurarte de
               que toda la información esté al día.
            </p>
            {/* VER IMAGENES */}
            <div
