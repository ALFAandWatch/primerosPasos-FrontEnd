      ...
      <>
         <div className="p-6 bg-[#d6dfe7] min-h-[100vh] flex flex-col">
            ...
            <p className="text-main font-(family-name:--font-montserrat) font-medium text-lg">
               ...
               tu contador relacionados con la liquidación de sueldos y el
               registro del personal de tu empresa. Revisa periódicamente este
               apartado para mantenerte al día con las obligaciones laborales y
